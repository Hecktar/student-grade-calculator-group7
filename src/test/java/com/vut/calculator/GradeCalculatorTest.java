...
public class GradeCalculatorTest {
    ...
    @Test
    public void testStudentReport_Admitted() {
        String report = calculator.generateStudentReport("Jane Doe", 50.0, 60.0);
        assertTrue(report.contains("Exam Admission: ADMITTED"));
        assertFalse(report.contains("Exam Admission: DENIED"));
    }

    @Test
    public void testStudentReport_Denied() {
        String report = calculator.generateStudentReport("John Smith", 35.0, 60.0);
        assertTrue(report.contains("Exam Admission: DENIED"));
        assertFalse(report.contains("Exam Admission: ADMITTED"));
    }
}
